...
has-tagged-techniques:: [[C# .NET]], #Postgresql, #SAS, #MSSQL, #Oracle, #Kerberos, #[[SAP HANA BIQ]], #Quartz.NET, #Serilog, #Loki, #Git, #[[Gitlab CI CD]], #Openshift 
has-tagged-roles:: #Developper, #[[Data analyst]], #[[Data architect]], #[[DevOps engineer]] 
has-linked-projects::
is-featured:: Yes
