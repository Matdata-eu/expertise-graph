...
- To document:
	- #ADFS, #Jira, #ClickOnce, #[[Project management]], #PMO, #[[JSON API]], #S3, #WMS, #Scichart, #SQL, #Binary, #[[RCM-DX format]], #LRS, #[[Data governance]], #Traccar, #HDF5, #Leaflet, #Accelerometers, #[[SAP CATS]], #GPSD, #Dbeaver, #PgAdmin
	-
