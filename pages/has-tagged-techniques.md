...
- To document:
	- #ESP32, #NodeMCU, #PLC, #Telnet, #[[PL/pgSQL]], #[[IBM MQ]], #[[MS Graph]], #ADFS, #Jira, #ClickOnce, #[[Project management]], #PMO, #[[JSON API]], #S3, #WMS, #Scichart, #SQL, #Binary, #[[RCM-DX format]], #LRS, #[[Data governance]], #Traccar, #HDF5
	-
