...
has-tagged-techniques:: [[C#]], #Git, #[[Gitlab CI CD]], #QGIS, #Angular, #Leaflet, #Qlikview, #PostGIS, #Postgresql, #Dbeaver, #MSSQL, #Kerberos, #Nginx, #Docker, #Openshift
has-tagged-roles:: #Developer, #[[Project lead]], #[[Data architect]]
has-linked-projects:: #[[Linear measurement data viewer]]
is-featured:: Yes
during-job:: #[[Job: engineer overhead contact lines]]

- ![image.png](../assets/image_1731862683788_0.png)
- ![image.png](../assets/image_1731862720711_0.png)