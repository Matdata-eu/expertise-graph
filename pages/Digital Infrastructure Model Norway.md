public:: true
type:: [[Project]]
description:: The project has as goal to build a knowledge graph of the railway infrastructure of Norway and generate railML v3.3 files for use cases such as RunTime Calculation (RTCI) and Runtime Simulation (RSIM)
