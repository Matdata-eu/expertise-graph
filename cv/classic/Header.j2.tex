    ...
    \begin{twocolentry}
        {
            \begin{figure}
            \raggedleft
            \includegraphics[width=0.7\linewidth]{../profile.jpg}
            \end{figure}    
        }
        {Innovative data freelancer with over 15 years of experience developing user-centered and data-centric IT systems. Starting from business idea and going all the way a solution in production and even beyond.}
    \end{twocolentry}
